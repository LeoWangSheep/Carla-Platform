...
class TurningObstacleScenario(DrivingScenario):
    def __init__(self, weather=None):
        ...
        self.info_dataframe['Scenario'] = 'Turning Obstacle'
    ...
    def change_next_position(self, position, mode):
        ...
        self._enemy_vehicle = Scenario._carla_env.spawn_new_actor(actor_blueprint_categories['car2'],
                                                                  enemy_vehicle_location, enemy_vehicle_rotation, False)
